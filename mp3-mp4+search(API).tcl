...
proc mptigatext { nick host hand chan text } {
	...
	set judulbaru [string map {" " "_" "ÂŽ" "" "ðŸŽ¶" "" "ðŸŽ§" "" "ðŸŽµ" "" "Ÿ" "" "¶" "" "?" "" "ð" "" "µ" "" {ماهر} {} {زين} {} {¤} {} {?} "" {`} "" {"} "" {} "" {?} "" {%} "persen" {[} "(" {]} ")" {|_} "" {/} "_" {|} "-" {/_} "-" {"_} "" {#} "" "é" "e"} $judul]
	putquick "PRIVMSG $chan :Trying to convert \002$judul\002 please wait..."
	if {$mptigasize != ""} {
		if {![matchattr $nick n]} {
			catch {exec youtube-dl --max-filesize $mptigasize --prefer-ffmpeg --rm-cache-dir --no-resize-buffer --no-cache-dir --no-playlist --no-mtime --ignore-config --geo-bypass --abort-on-error --no-color --no-mark-watched --no-call-home --no-warnings --youtube-skip-dash-manifest -w -x --audio-format mp3 --audio-quality 0 -o "$path/public_html/$judulbaru.%(ext)s" $yturl} mptigaruncmd
		} else {
			catch {exec youtube-dl --prefer-ffmpeg --rm-cache-dir --no-resize-buffer --no-cache-dir --no-playlist --no-mtime --ignore-config --geo-bypass --abort-on-error --no-color --no-mark-watched --no-call-home --no-warnings --youtube-skip-dash-manifest -w -x --audio-format mp3 --audio-quality 0 -o "$path/public_html/$judulbaru.%(ext)s" $yturl} mptigaruncmd
		}
	} else {
		catch {exec youtube-dl --prefer-ffmpeg --rm-cache-dir --no-resize-buffer --no-cache-dir --no-playlist --no-mtime --ignore-config --geo-bypass --abort-on-error --no-color --no-mark-watched --no-call-home --no-warnings --youtube-skip-dash-manifest -w -x --audio-format mp3 --audio-quality 0 -o "$path/public_html/$judulbaru.%(ext)s" $yturl} mptigaruncmd
	}
	foreach line [split $mptigaruncmd "\n"] { 
		if {[string match "ERROR:*" $line]} {
			if {[string match "*unable to download video data*" $line]} { puthelp "PRIVMSG $chan :Convert unsuccessful. Reason: $line (\002Try again\002)" ; return 0 }
...
proc mptigalink { nick host hand chan text } {
	...
	if {$mptigasize != ""} {
		if {![matchattr $nick n]} {
			catch {exec youtube-dl --max-filesize $mptigasize --prefer-ffmpeg --rm-cache-dir --no-resize-buffer --no-cache-dir --no-playlist --no-mtime --ignore-config --geo-bypass --abort-on-error --no-color --no-mark-watched --no-call-home --no-warnings --youtube-skip-dash-manifest -w -x --audio-format mp3 --audio-quality 0 -o "$path/public_html/$judulbaru.%(ext)s" $text} mptigaruncmdd
		} else {
			catch {exec youtube-dl --prefer-ffmpeg --rm-cache-dir --no-resize-buffer --no-cache-dir --no-playlist --no-mtime --ignore-config --geo-bypass --abort-on-error --no-color --no-mark-watched --no-call-home --no-warnings --youtube-skip-dash-manifest -w -x --audio-format mp3 --audio-quality 0 -o "$path/public_html/$judulbaru.%(ext)s" $text} mptigaruncmdd
		}
	} else {
...
proc mpempattext { nick host hand chan text } {
	...
	if {$mpempatsize != ""} {
		if {![matchattr $nick n]} {
			catch {exec youtube-dl --max-filesize $mpempatsize --prefer-ffmpeg --rm-cache-dir --no-resize-buffer --no-cache-dir --prefer-ffmpeg --no-playlist --no-mtime --abort-on-error --no-color --no-mark-watched --no-call-home --youtube-skip-dash-manifest -w -f mp4 -o "$path/public_html/$judulbaru.%(ext)s" $yturl} mpempatruncmd
		} else {
			catch {exec youtube-dl --prefer-ffmpeg --rm-cache-dir --no-resize-buffer --no-cache-dir --no-playlist --no-mtime --abort-on-error --no-color --no-mark-watched --no-call-home --youtube-skip-dash-manifest -w -f mp4 -o "$path/public_html/$judulbaru.%(ext)s" $yturl} mpempatruncmd
		}
	} else {
		catch {exec youtube-dl --prefer-ffmpeg --rm-cache-dir --no-resize-buffer --no-cache-dir --no-playlist --no-mtime --abort-on-error --no-color --no-mark-watched --no-call-home --youtube-skip-dash-manifest -w -f mp4 -o "$path/public_html/$judulbaru.%(ext)s" $yturl} mpempatruncmd
	}
...
proc mpempatlink { nick host hand chan text } {
	...
	if {$mpempatsize != ""} {
		if {![matchattr $nick n]} {
			catch {exec youtube-dl --max-filesize $mpempatsize --prefer-ffmpeg --rm-cache-dir --no-resize-buffer --no-cache-dir --prefer-ffmpeg --no-playlist --no-mtime --abort-on-error --no-color --no-mark-watched --no-call-home --youtube-skip-dash-manifest -w -f mp4 -o "$path/public_html/$judulbaru.%(ext)s" $text} mpempatruncmdd
		} else {
			catch {exec youtube-dl --prefer-ffmpeg --rm-cache-dir --no-resize-buffer --no-cache-dir --no-playlist --no-mtime --abort-on-error --no-color --no-mark-watched --no-call-home --youtube-skip-dash-manifest -w -f mp4 -o "$path/public_html/$judulbaru.%(ext)s" $text} mpempatruncmdd
		}
	} else {
		catch {exec youtube-dl --prefer-ffmpeg --rm-cache-dir --no-resize-buffer --no-cache-dir --no-playlist --no-mtime --abort-on-error --no-color --no-mark-watched --no-call-home --youtube-skip-dash-manifest -w -f mp4 -o "$path/public_html/$judulbaru.%(ext)s" $text} mpempatruncmdd
	}
...
proc search {nick uhost hand chan text} {
	...
	#set url "https://www.googleapis.com/youtube/v3/search?part=snippet&fields=items(id(videoId))&key=$key&q=$text"
	set ids [getinfo $url]
...
proc searchlagu {nick uhost hand chan text} {
	...
	if {$text == ""} { puthelp "PRIVMSG $chan :Syntax:\002 .cari <text> \002" ; return 0 }
	regsub -all {\s+} $text "%20" text
	set text [string map {{"} {'} {`} {'}} $text]
