...
proc playlist:list {nick host hand chan text} {
	global allowplaylist
	if {$allowplaylist == 0} { puthelp "PRIVMSG $chan :Playlist is \002Allowed\002" ; return }
	if {$allowplaylist == 1} { puthelp "PRIVMSG $chan :Playlist is \002Not allowed\002" ; return }
}
...
proc carilaguinfo {nick uhost hand chan text} {
	...
	if {[channel get $chan ytconvert] && [regexp -nocase -- {(?:http(?:s|).{3}|)(?:www.|)(?:youtube.com\/watch\?.*v=|youtu.be\/)([\w-]{11})} $text url id]} {
		...
		puthelp "PRIVMSG $chan :\002\00301,00You\00300,04Tube\003\002 \002$title\002 by $user (duration: $isotime)"
